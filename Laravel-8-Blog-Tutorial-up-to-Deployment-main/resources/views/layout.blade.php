...
<head>
    ...
    <title>Blog UKM Sanggar Seni</title>
    <!-- Css -->
...
<body>
    <div id="wrapper">
        ...
        <div class="sidebar">
            ...
            <p class="brand-title"><a href="">Blog Sanggar Seni</a></p>
            ...
            <footer class="sidebar-footer">
                <div>
                    ...
                    <a href="http://instagram.com/ukmsanggarseni.pnl"><i class="fab fa-instagram"></i></a>
                    <a href=""><i class="fab fa-twitter"></i></a>
                </div>

                <small>&copy 2022 Blog UKM Sanggar Seni</small>
            </footer>
        </div>
        <!-- Menu Button -->
